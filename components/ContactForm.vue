<template>
    <!-- Quote Start -->
    <div id="contacto" class="container-fluid quote my-5 py-5" data-parallax="scroll">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <div class="bg-white rounded p-4 p-sm-5 wow fadeIn" data-wow-delay="0.5s">
                        <h1 class="display-5 text-center mb-5">Contacta con nosotros</h1>
                        <div class="row g-3">
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    ...
                                    <label for="cname">Tu Teléfono</label>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-floating">
                            ...
                            <div class="col-12 text-center">
                                <button class="btn btn-primary py-3 px-4" type="submit">Te llamaremos</button>
                            </div>
                        </div>
                    </div>
                </div>
...
export default {
    name: 'ContactForm',
    mounted() {
        $('#contacto').parallax({imageSrc: '/img/carousel-2.jpg'});
    },
}
